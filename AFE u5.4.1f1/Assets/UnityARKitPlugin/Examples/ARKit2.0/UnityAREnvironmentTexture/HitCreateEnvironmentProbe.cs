...
public class HitCreateEnvironmentProbe : MonoBehaviour
{
    ...
    [ContextMenu("CheckHitAndCreateProbe")]
    public void CheckHitAndCreateProbe()
    {
        var screenPosition = Camera.main.ScreenToViewportPoint(new Vector3(Screen.width / 2f, Screen.height / 2f, 0));
