...
public class ThirdPersonCameraEditor : PropertyEditor
{
    ...
    private SerializedProperty boolFreeUpdateProperty;
    private SerializedProperty boolFollowUpdateProperty;
    private SerializedProperty boolDistanceUpdateProperty;
    ...
    protected override void Initialize()
    {
        ...
        boolFreeUpdateProperty = serializedObject.FindProperty("boolFreeUpdate");
        boolFollowUpdateProperty = serializedObject.FindProperty("boolFollowUpdate");
        followUpdateSpeedProperty = serializedObject.FindProperty("followUpdateSpeed");
        boolDistanceUpdateProperty = serializedObject.FindProperty("boolDistanceUpdate");
    ...
    public override void OnInspectorGUI()
    {
        ...
        PropertyField("boolFreeUpdate", boolFreeUpdateProperty);
        PropertyField("boolFollowUpdate", boolFollowUpdateProperty);
        PropertyField("boolDistanceUpdate", boolDistanceUpdateProperty);
        EndSection();
