...
public class ThirdPersonControllerEditor : PropertyEditor
{
    ...
    private SerializedProperty groundedProperty;
    private SerializedProperty walkingProperty;
    ...
    protected override void Initialize()
    {
        ...
        groundedProperty = serializedObject.FindProperty("grounded");
        walkingProperty = serializedObject.FindProperty("walking");
    ...
    public override void OnInspectorGUI()
    {
        ...
        PropertyField("grounded", groundedProperty);
        PropertyField("walking", walkingProperty);        
