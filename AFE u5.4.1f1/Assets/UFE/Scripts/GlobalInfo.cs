...
public class AIOptions
{
    ...
    [HideInInspector]
    public AIDifficultyLevel selectedDifficultyLevel = AIDifficultyLevel.Normal;
    [HideInInspector]
    public AIDifficultySettings selectedDifficulty;
}
...
{
    [HideInInspector]
    public string announcerName = string.Empty;
